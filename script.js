// ========================= // SCREEN REFERENCES //
========================= const loadingScreen =
document.getElementById(“loadingScreen”); const welcomeScreen =
document.getElementById(“welcomeScreen”); const introScreen =
document.getElementById(“introScreen”); const quizScreen =
...
const quizData = [ {question:“Who is the most beautiful girl?
❤️”,answers:[“Diksha ❤️”,“Someone Else”,“Nobody”,“Don’t
Know”],correct:0}, {question:“Who makes me smile everyday?
😊”,answers:[“Diksha ❤️”,“Mobile”,“Friends”,“Food”],correct:0},
{question:“Today’s Birthday Queen is? 👑”,answers:[“Diksha
❤️”,“Me”,“Nobody”,“Everyone”],correct:0}];
...
function checkAnswer(i){ alert(i===quizData[currentQuestion].correct?“❤️
Correct!”:“😊 Nice Try!”); }
...
window.addEventListener(“load”,()=>{setTimeout(()=>showScreen(welcomeScreen),3000);});
